...
public class DBInitializer
{
    public static async Task SeedData(AppDbContext context)
    {
        ...
        // Adds the list of activities to the Activities table in the database context.
        // This schedules the new activities to be inserted into the database when SaveChangesAsync() is called.
